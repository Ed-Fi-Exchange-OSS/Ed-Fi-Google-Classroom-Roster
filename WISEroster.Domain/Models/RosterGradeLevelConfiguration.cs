...
namespace WISEroster.Domain.Models
{
    ...
    public partial class RosterGradeLevelConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<RosterGradeLevel>
    {
        public RosterGradeLevelConfiguration()
            : this("dbo")
        {
        }

        public RosterGradeLevelConfiguration(string schema)
        {
            ToTable("RosterGradeLevel", schema);
            HasKey(x => new { x.RuleId, x.GradeLevelDescriptorId });
            ...
            // Foreign keys
            HasRequired(a => a.ProvisioningRule).WithMany(b => b.RosterGradeLevels).HasForeignKey(c => c.RuleId); // FK_RosterGradeLevel_ProvisioningRules
            InitializePartial();
        }
